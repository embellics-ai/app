...
-- We only need external_service_name to identify which service the branch_id belongs to

-- Drop the redundant external_branch_id column
ALTER TABLE "tenant_branches" DROP COLUMN IF EXISTS "external_branch_id";

-- Update the index to use branch_id instead of external_branch_id
