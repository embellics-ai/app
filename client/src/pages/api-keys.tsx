          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Create your first API key to start embedding the chat widget on
                your website
              </p>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This action cannot be undone. Any websites using this
                          key will no longer be able to load the chat widget.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Full key was only shown at creation time and is not stored
                      in our database for security.
                    </p>
                  </div>
                </div>
              </CardContent>
