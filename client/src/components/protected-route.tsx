...
const ROUTE_ACCESS: RouteAccess[] = [
  ...
  { path: "/test-chat", requirePlatformAdmin: false, allowedRoles: ["client_admin", "support_staff"] },
  
  // Support Staff / Agent routes
  { path: "/agent-dashboard", requirePlatformAdmin: false, allowedRoles: ["client_admin", "support_staff"] },
  
  // Shared routes (all authenticated users)
  { path: "/change-password", requirePlatformAdmin: undefined, allowedRoles: ["admin", "client_admin", "support_staff", "owner"] },
