...
import { pgTable, text, varchar, timestamp, jsonb, integer, boolean, uniqueIndex } from "drizzle-orm/pg-core";
...
export const userInvitations = pgTable("user_invitations", {
  ...
  invitedUserId: varchar("invited_user_id").references(() => clientUsers.id, { onDelete: "cascade" }), // Set when invitation is accepted - cascade delete when user is deleted
...
export const conversations = pgTable("conversations", {
  ...
  humanAgentId: varchar("human_agent_id").references(() => humanAgents.id, { onDelete: "set null" }),
